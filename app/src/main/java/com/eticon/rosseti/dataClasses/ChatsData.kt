...
val notification = listOf<Notification>(
        Notification("Предложение №1","Статус вашего предложения изменен на: идет опытное тестирование", "27 ноября 2020"),
        Notification("Предложение №1","Статус вашего предложения изменен на: признано", "26 ноября 2020"),
        Notification("Предложение №2","В обсуждении вашего предложения появились новые комментарии", "26 ноября 2020")
)