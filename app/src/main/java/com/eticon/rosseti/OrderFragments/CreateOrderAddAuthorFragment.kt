 ...
 * Use the [CreateOrderAddAuthorFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CreateOrderAddAuthorFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CreateOrderAddAuthorFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CreateOrderAddAuthorFragment().apply {
